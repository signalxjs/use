 ...
 * element/EventTarget, a getter, a signal-shaped `{ value }` handle, or a
 * sigx template-ref `{ current }` object. Reading a reactive handle tracks,
 * so watchers re-run when the element changes.
 *
