// ============================================================================
// @sigx/use/web - SSR-safe DOM composables
// ============================================================================
// Every function here takes { window?, document?, navigator? } configurable
// globals (the SSR seam and the test seam) and returns inert initial-value
// signals on the server, attaching nothing.
